...
async function fetchAccessibilityPageData() {
  ...
  const response = await fetch(
    `https://dev-api.instient.com/api/accessibilitypage`, 
    {
      headers: {
...
export default async function AccessibilityPage() {
  ...
  const { Title, header, Description, content1, content1_answer, content2, content2_answer, conclusion } = accessibilityData;
