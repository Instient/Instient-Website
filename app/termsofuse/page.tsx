...
async function fetchTermsOfUsePageData() {
  ...
  const response = await fetch(
    `https://dev-api.instient.com/api/termsofusepage`, 
    {
      headers: {
...
export default async function TermsOfUsePage() {
  ...
  const { Title, header, Description, content1, content1_answer, content2, content2_answer, conclusion } = termsOfUseData;
