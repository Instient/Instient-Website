...
async function fetchCookieSettingsPageData() {
  ...
  const response = await fetch(
    `https://dev-api.instient.com/api/cookiesettingspage`, 
    {
      headers: {
...
export default async function CookieSettingsPage() {
  ...
  const { Title, header, Description, content1, content1_answer, content2, content2_answer, conclusion } = cookieSettingsData;
